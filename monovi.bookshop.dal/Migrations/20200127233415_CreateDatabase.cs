        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    ISBN = table.Column<string>(maxLength: 25, nullable: false),
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        name: "FK_Products_UserAccount_CreatedUserID",
                        column: x => x.CreatedUserID,
                        principalTable: "UserAccount",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_Products_UserAccount_ModifiedUserID",
            ...
            migrationBuilder.InsertData(
                ...
                values: new object[] { 1, "Test@test.com", "Test User", "testUser" });
